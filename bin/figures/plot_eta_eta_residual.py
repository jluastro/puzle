...
def plot_eta_eta_threshold(eta_arr=None, eta_threshold_low_best=None):
    if eta_arr is None:
        eta_arr, _, eta_threshold_low_best = return_cands_level2_eta_arrs()
...
def plot_eta_residual_ulens_vs_actual(eta_residual_ulens_arr=None,
    ...
    if eta_residual_ulens_arr is None:
        _, eta_residual_ulens_arr, eta_residual_actual_ulens_arr, _,_, observable_arr = return_ulens_level2_eta_arrs()
