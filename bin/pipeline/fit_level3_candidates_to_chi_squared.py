...
def fit_level3_candidates_to_chi_squared():
    ...
    for idx in my_idx_arr:
        ...
        for tE_factor in [1, 2, 3]:
            ...
            chi_squared_inside, chi_squared_outside, num_inside = data
            key = f'{tE_factor}tE_best'
            update_dct[f'chi_squared_inside_{key}'] = chi_squared_inside
            update_dct[f'chi_squared_outside_{key}'] = chi_squared_outside
            update_dct[f'num_epochs_inside_{key}'] = int(num_inside)
